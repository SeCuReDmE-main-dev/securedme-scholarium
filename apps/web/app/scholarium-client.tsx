        ...
        {view === "toolchain" ? (
          <section className="library-page" aria-label="SecuredMe Education toolchain">
            ...
            <div className="migration-review-list">
              <article className="publication-card"><div className="publication-body"><p className="eyebrow">LANGUAGE / PRE-ALPHA</p><h3>Scholarium Teach</h3><p>Explore a syllable-first, deterministic learning engine that keeps image, audio, mastery, provenance, and human-review boundaries visible. Real-student pilots remain closed pending qualified legal review; synthetic demonstrations are available.</p><div className="tool-actions"><a href="/teach">Open Teach</a><a href="https://securedme-main-dev.github.io/securedme-scholarium/en/tools/scholarium/" rel="noreferrer">Read the contract</a></div></div></article>
              <article className="publication-card"><div className="publication-body"><p className="eyebrow">MISSION / FIRST PROOF</p><h3>AlgoQuest</h3><p>Enter through a governed Hero Books mission. Narrative rewards never stand in for mastery, and AlgoQuest alone decides progression from admitted evidence.</p><div className="tool-actions"><a href="https://algoquest.securedme.ca" rel="noreferrer">Open AlgoQuest</a><a href="https://securedme-main-dev.github.io/securedme-scholarium/en/tools/algoquest-qbit/" rel="noreferrer">Read the contract</a></div></div></article>
              <article className="publication-card"><div className="publication-body"><p className="eyebrow">BUILD / MV3 SIDE PANEL</p><h3>Algorithm Builder</h3><p>Build the Mage artifact as a deterministic typed card program, validate it locally, and prepare a Colab notebook without surrendering mission or progression authority.</p><div className="tool-actions"><a href="https://algorithm-builder.securedme.ca" rel="noreferrer">Open Builder</a><a href="https://securedme-main-dev.github.io/securedme-scholarium/en/tools/algorithm-builder/" rel="noreferrer">Read the contract</a></div></div></article>
              <article className="publication-card"><div className="publication-body"><p className="eyebrow">GEOMETRY / SUPERVISED ALPHA</p><h3>FfeD-QLC with Vigil</h3><p>Move through nine bounded laboratories, inspect FQLC1 and exact geometric traces, then give the evidence and its limits to a professor. Synthetic fixtures only; no cryptographic certification is claimed.</p><div className="tool-actions"><a href="https://ffed-qlc.securedme.ca" rel="noreferrer">Open FfeD-QLC</a><a href="https://securedme-main-dev.github.io/securedme-scholarium/en/tools/ffed-qlc/" rel="noreferrer">Read the contract</a></div></div></article>
            </div>
            <section className="transparency-card"><strong>Shared Gateway, separate login proof</strong><p>The Gateway audits twelve Codex and Antigravity adapter templates, rejects secret material, and exposes bounded CLI/MCP mechanisms. It is not an identity provider or a substitute for each application’s callback, account binding, expiry, logout, recovery, and accessibility tests.</p><a href="https://securedme-main-dev.github.io/securedme-scholarium/en/tools/fnpqnn-gateway/" rel="noreferrer">Inspect the Gateway contract</a></section>
          </section>
        ) : view === "migration" ? (
