# Scholarium — embedded CodeProject.AI node

This repository starts a complete, isolated CodeProject.AI Server 2.9.7 instance as `cpai-scholarium` on host port `32176`. Compose uses the official image pinned by digest; no CodeProject.AI binaries are committed. Configuration and module data live in repository-specific Docker volumes.
