...
```powershell
git clone https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard.git
cd market-guardian-retailguard
...
- [Project README](https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard/blob/HEAD/README.md)
- [Contribution guide](https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard/blob/HEAD/CONTRIBUTING.md)
- [Security policy](https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard/blob/HEAD/SECURITY.md)
- [Safety boundary](https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard/blob/HEAD/SAFETY.md)
- [License](https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard/blob/HEAD/LICENSE)
- [Agent instructions](https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard/blob/HEAD/AGENTS.md)

## Open the project

- [Public project surface](https://retailguard.securedme.ca)
- [Source repository](https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard)
- [Issues](https://github.com/SeCuReDmE-main-dev/market-guardian-retailguard/issues)
