...
Preserve I -> I_system^S -> H_lex -> G_lex -> I_lexicon; Synthia supports traceability and does not certify taxonomy or science.
...
The current public documentation describes `0.1.0` with status `public-preview`. Consult the repository history and release notes for changes.
