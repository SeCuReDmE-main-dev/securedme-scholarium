...
```powershell
git clone https://github.com/SeCuReDmE-main-dev/algorithm-builder-app.git
...
- [Project README](https://github.com/SeCuReDmE-main-dev/algorithm-builder-app/blob/HEAD/README.md)
- [Contribution guide](https://github.com/SeCuReDmE-main-dev/algorithm-builder-app/blob/HEAD/CONTRIBUTING.md)
- [Security policy](https://github.com/SeCuReDmE-main-dev/algorithm-builder-app/blob/HEAD/SECURITY.md)
- [Safety boundary](https://github.com/SeCuReDmE-main-dev/algorithm-builder-app/blob/HEAD/SAFETY.md)
- [License](https://github.com/SeCuReDmE-main-dev/algorithm-builder-app/blob/HEAD/LICENSE)
- [Agent instructions](https://github.com/SeCuReDmE-main-dev/algorithm-builder-app/blob/HEAD/AGENTS.md)

## Open the project

- [Public project surface](https://algorithm-builder.securedme.ca)
- [Source repository](https://github.com/SeCuReDmE-main-dev/algorithm-builder-app)
- [Issues](https://github.com/SeCuReDmE-main-dev/algorithm-builder-app/issues)
